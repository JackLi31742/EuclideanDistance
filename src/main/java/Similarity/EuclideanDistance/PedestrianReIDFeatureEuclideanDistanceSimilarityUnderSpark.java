...
//
//public class PedestrianReIDFeatureEuclideanDistanceSimilarityUnderSpark extends SparkStreamingApp{
//	/**
//	 * 
//	 */
...
//	
//	
//	public PedestrianReIDFeatureEuclideanDistanceSimilarityUnderSpark(SystemPropertyCenter propCenter) throws Exception{
//		super(propCenter, APP_NAME);
//	}
//
//	public double getSim(float[] a, float[] b) {
//		double distance = 0;
//
...
//	public void getSim(List<ReIdAttributesTemp> list) throws Exception {
//		// 前k个
//		int k = 3;
//		//
//		
...
//
//        SparkStreamingApp app = new PedestrianReIDFeatureEuclideanDistanceSimilarityUnderSpark(propCenter);
//        app.initialize();
//        app.start();
