...
//	}
	...
	public static void getSim(List<ReIdAttributesTemp> list) throws Exception {
		// 前k个
		int k = 3;
		//
...
//
//        SparkStreamingApp app = new PedestrianReIDFeatureEuclideanDistanceSimilarity(propCenter);
//        app.initialize();
//        app.start();
...
//	@Override
	public static void addToContext() throws Exception {
