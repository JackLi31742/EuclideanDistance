...
package Similarity.EuclideanDistance.util;
 ...
 */
public class SingletonUtil<T> implements Serializable {
     ...
     */
    public <U extends T> SingletonUtil(Factory<U> objFactory, Class<U> type) throws Exception {
