...
public class JdbcUtils {
	...
	// 饿汉式
//	private static DataSource ds = new ComboPooledDataSource("c3p0neo4j");
//	static{
...
//	private JdbcUtils(){}
	...
	private static DataSource ds=DataSourceSingleton.getDataSource();
	...
	public static Connection getConnection() {
		...
		if (con != null) {
			System.out.println("获取连接成功！"+con.hashCode());
			return con;
		} else {
			try {
